...
- [dsh-cert-mcp](https://github.com/PerryLink/dsh-cert-mcp) - Read-only MCP server exposing the dsh-plugin-certification registry: certification grades, snapshot dates, and five-dimension evidence for DSH plugins.
