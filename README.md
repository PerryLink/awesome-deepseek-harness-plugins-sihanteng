...
- [dsh-autotier](https://github.com/PerryLink/dsh-autotier) - Automatic strong/cheap model-tier routing for DeepSeek Harness: intent-gated tier landing on the agent/request waterfall, plan-mode handoff, deterministic high-risk guards, TTL escalation fallback, a /tier command, and tier status tools.
