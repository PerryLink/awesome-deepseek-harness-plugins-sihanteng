...
- [dsh-plugin-doctor](https://github.com/PerryLink/dsh-plugin-doctor) - Zero-dependency static + sandbox smoke detector for DSH plugins (R/K/D/CC layers): manifest/patch/entry/build/pack/install verification, a model-callable plugin_check, and supply-chain poison preflight.
